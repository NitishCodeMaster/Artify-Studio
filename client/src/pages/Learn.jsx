...
export default function Learn() {
  ...
  return (
    <>
      <section className="relative min-h-screen overflow-hidden bg-[#050505] py-10 sm:py-14 lg:py-16">
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1680px] px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            ...
            className="relative mt-12 overflow-hidden rounded-[1.5rem] border border-white/10 bg-gradient-to-r from-indigo-900/40 to-purple-900/40 p-5 text-center sm:mt-16 sm:rounded-[2rem] sm:p-8"
          >
